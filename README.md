...
[![NPM Version](https://img.shields.io/npm/v/@hishprorg/rem-atque-similique.svg?&style=flat-square)](https://www.npmjs.org/package/@hishprorg/rem-atque-similique)
[![Build Status](https://api.travis-ci.org/Alex-Werner/@hishprorg/rem-atque-similique.svg?branch=master)](https://travis-ci.com/Alex-Werner/@hishprorg/rem-atque-similique)
...
```js
const {FSLock, File, Directory} = require('@hishprorg/rem-atque-similique');
